...
exports.contactForm = (req, res) => {
    ...
    const replyData = {
        ...
        text:`Congratulations! Your are successfully registered for ECHO-DELHI 2020 MIDTERM : DIGITAL EXPERIENCE. Please mark the webinar details: Sunday, October 11th, 2020 3:00pm-9.00 pm`,
        html:
            `
                <h1><mark>ECHO-DELHI 2020 MIDTERM : DIGITAL EXPERIENCE</mark></h1>
                <p><b>Hello ${name},</b></p>
                <p>Congratulations!</p>
                <p>You are successfully registered for ECHO-DELHI 2020 MIDTERM : DIGITAL EXPERIENCE.</p>
